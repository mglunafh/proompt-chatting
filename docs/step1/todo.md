...
- **W-05 Endpoint and upgrade** — the WebSocket route: take the name, validate it, register or refuse, run the read loop, answer a rejected command with a typed error frame. First unit under `testApplication`. MSG-04, ST1-01.
